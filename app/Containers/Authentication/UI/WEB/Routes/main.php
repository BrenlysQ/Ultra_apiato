...
$router->group(['domain' => parse_url(\Config::get('app.url'))['host']], function ($router) {
    ...
    $router->post('/reset_password', [
        'uses'       => 'ResetPassword@resetForm'
    ]);
    $router->post('/reset_passwordact', [
        'uses'       => 'ResetPassword@resetFormAct'
    ]);
});
