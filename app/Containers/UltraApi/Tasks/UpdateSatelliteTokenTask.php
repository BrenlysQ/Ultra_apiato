 ...
 */
class UpdateSatelliteTokenTask extends Task{
    ...
    public function run($response,$satellite)
    {
      ...
      $sat_to_update = API_satellite::where('domain',$satellite->domain)->get();
      $token_sat = API_satellite::findOrFail($sat_to_update[0]->id);        
      $token_sat->token()->update([
